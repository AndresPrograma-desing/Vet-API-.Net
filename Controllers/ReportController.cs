...
namespace vet_api_Net.Controllers
{
	...
	public class ReportController : ControllerBase
	{
        ...
        private readonly IGenerateReportExcel _excelGen;
        private readonly IWebHostEnvironment _env;
        private readonly string? _externalBaseUrl;


		public ReportController(IReportSystemService reportService, IGenerateReportExcel excelGen, IWebHostEnvironment env, IConfiguration config)
		{
...
{
    await _reportService.ToggleAutoDeleteAsync(enable);
...
{
    await _reportService.ToggleAutoGenerateAsync(enable);
