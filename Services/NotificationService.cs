...
public class NotificationService : INotificationService
{
    ...
    public NotificationService(IAlertsRepository alertsRepository, IUsersRepository usersRepository)
    {
    ...
    public async Task<AlertNotificationDTO> CreateNotificationAsync(AlertNotificationDTO dto)
    {
    ...
    {
        return await _alertsRepository.MarkAsReadAsync(alertId);
    }
}